            ...
            <form method="post" class="form auto-form" autocomplete="off"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-5">
                            <label class="col-form-label">
                            	<?php if ($list['score'] == 3): ?>好评<?php endif; ?>
                        		<?php if ($list['score'] == 2): ?>中评<?php endif; ?>
                        		<?php if ($list['score'] == 1): ?>差评<?php endif; ?>
                        	</label>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-5">
                        	<a class="btn btn-success" href="<?= $urlManager->createUrl(['mch/comment/index']) ?>">返回</a>
