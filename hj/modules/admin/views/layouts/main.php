...
$copyright = $copyright ? $copyright : '©2017 <a href="http://www.redkylin.com" target="_blank">一维网络工作室</a>';
...
<head>
    ...
    <title><?= !empty($this->title) ? $this->title . ' - ' : null ?><?= Option::get('name', 0, 'admin', '一维网络工作室') ?></title>
    <link rel="stylesheet"
