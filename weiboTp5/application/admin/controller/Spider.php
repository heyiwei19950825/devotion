...
use think\Loader;
use think\Log;
use app\admin\model\Celebrity as CelebrityModel;
...
class Spider extends Controller
{
    ...
    public function getQQMusicByMid(){

//        //获取音乐列表 c.y.qq.com/splcloud/fcgi-bin/fcg_get_diss_by_tag.fcg
//        $musicList = helper::http_curl('c.y.qq.com/splcloud/fcgi-bin/fcg_get_diss_by_tag.fcg',[
//        'platform'    => 'yqq',
//        'hostUin'     => 0,
//        'sin'         => 0,
//        'ein'         => 29,
